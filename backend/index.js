...
app.get("/search", authenticateToken, async(req, res)=> {
  ...
  try {
    // in search results $or is used to filter the search based on any of the key word from title, story, visitedLoaction(important)
...
app.get("/travel-story/filter", authenticateToken, async(req, res)=> {
  ...
  try {
    // convert start date & end date from milliseconds to date objects
